...
include("db_conection.php");
  ...
  $query="select * from coordinator where user_name='".$_SESSION['user']."'";
	   ...
	   $view_data="select part_id,tname,usn,branch,sem,place,score,description from info where events='".$_SESSION['events']."' order by score desc";//select query for viewing users.
