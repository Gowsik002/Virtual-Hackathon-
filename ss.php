...
<br><br>	<input type="text" style="text-transform:uppercase" name="tname" placeholder="NAME OF TEAM" required ><br ><br >
    ...
    <option value="8">8</option>
	   ...
	   <textarea  name="desc" rows="4" style="text-transform:uppercase" cols="60" placeholder="Description in detail"></textarea><br><br>
	   <br><b><h3>REGISTRATION FEE : 250 rs<h3><img src="img/upi.jpg"><br><br>
...
$check_user="select * from info WHERE events='$events' and usn='$usn' and tid='$tid'";
    ...
    if(mysqli_num_rows($run)<1){     
        ...
        $sql = "INSERT INTO info (part_id,events,event_type,tname,name, usn, branch,sem, mobile,email,msg,description,tid) VALUES ('$part_id','$events','$event_type','$tname','$name', '$usn', '$branch','$sem','$mobile','$email','$msg','$desc','$tid')";
